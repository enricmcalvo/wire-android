...
@Database(
    entities = [UserEntity::class, AssetsV1Entity::class, ConversationsEntity::class,
        ...
        SyncJobsEntity::class, ErrorsEntity::class, NotificationDataEntity::class, UserClientsEntity::class,
        LikesEntity::class, MessageDeletionEntity::class, ConversationRoleActionEntity::class,
