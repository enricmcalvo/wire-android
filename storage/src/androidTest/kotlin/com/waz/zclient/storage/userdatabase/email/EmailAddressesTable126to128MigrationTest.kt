...
class EmailAddressesTable126to128MigrationTest : UserDatabaseMigrationTest(126, 128) {
    ...
    @Test
    fun givenRoomDbVersionIs126WhenMigratedFrom126To128ThenEnsureEmailAddressesTableIsDropped() {
        assertFalse(EmailAddressesTableTestHelper.doesRoomTableExist(db))
    }
}
